...
read_vcf_impl <- function(path, region, index, fields, info_fields, genotype_fields, genotype_by, samples, samples_nested) .Call(wrap__read_vcf_impl, path, region, index, fields, info_fields, genotype_fields, genotype_by, samples, samples_nested)

#' Return Arrow IPC format from a BCF file.
read_bcf_impl <- function(path, region, index, fields, info_fields, genotype_fields, genotype_by, samples, samples_nested) .Call(wrap__read_bcf_impl, path, region, index, fields, info_fields, genotype_fields, genotype_by, samples, samples_nested)
